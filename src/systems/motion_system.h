...
public:
    ...
    physx::PxRigidStatic* createStatic(const std::vector<physx::PxTriangleMesh*>& triangleMeshes, glm::vec3 mat, glm::vec3 transf);
    ...
    void loadObjToPhysX(const std::string& filePath, std::vector<physx::PxTriangleMesh*>& triangleMeshes);
